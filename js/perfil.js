let nombreUsusario = localStorage.getItem("userName");
$('#nombreUsusario').text(nombreUsusario);
...
function loadPhotos() {
    ...
    $.ajax({
        url: "http://localhost:3000/photos?userId=" + id + "&_sort=date&_order=desc&_limit=3",
